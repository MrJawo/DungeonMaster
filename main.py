...
def choose_character(character_name):
    ...
    while True:
        ...
        if character_choice == "1":
            ...
            hero = classes.Hero(character_name, "AI_Riddare")
            hero.add_ai_knight()
            return hero
        elif character_choice == "5":
            hero = classes.Hero(character_name, "AI_Trollkarl")
            hero.add_ai_wizard()
            return hero
        elif character_choice == "6":
            hero = classes.Hero(character_name, "AI_Tjuv")
            hero.add_ai_thief()
            return hero
        else:
            print("\n-- Felaktig input, ange en siffra från menyn. --")
...
def take_step(coordinates, grid_size,hero, game_board):
    while True:
        if hero.ai:
            ...
            print('i have coordinates ' ,coordinates_list)
            if coordinates_list:
                break
            print('AGAIN i have coordinates ' ,coordinates_list)
        else:
    ...
    print('Returned coordinates list', coordinates_list)
...
def walk_on_board(hero, grid_size, game_board, room_list):
    ...
    while True:
        get_out_coordinates = hero.coordinates
